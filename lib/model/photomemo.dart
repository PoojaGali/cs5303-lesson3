...
class PhotoMemo {
  ...
  static const READ_TEXT = 'readtext';
  ...
  void assign(PhotoMemo p) {
    ...
    this.readText.clear();
    this.readText.addAll(p.readText);
  }
